...
<div class="row" ng-app="bssrApp" ng-controller="bssrCategoryController">
...
<div class="col-md-9">
    ...
    <center><button class="btn btn-success" id="loadmore" ng-click="loadMore(catid)">&nbsp;&nbsp;&nbsp;Load More &nbsp;&nbsp;&nbsp;</button></center>
</div>
</div>

<!-- AngularJS Application Scripts -->
<script src="<?= asset('app/controllers/category.js') ?>"></script>
