...
<a href="{{ url('details/'.$data->id) }}" class="block-link"> 
    ...
    <div class="row">
		...
		<font size="5" color="#575858">{{$data->advtopic }}</font> 
			...
			@if ($data->email)
			<img src="images/email.jpg" height="20px" width="18px" title="Email">{{ $data->email }}
			&nbsp;&nbsp;
			@endif
			</p>
			<p>
			@if ($data->phone)
			<img src="images/phone.jpg" height="20px" width="18px" title="Phone">{{ $data->phone }}
			@endif
		...
		<font color="#a6a9a9" size="2">
                <img src="images/location.jpg" height="20px" width="17px"> {{ $data->placename }}
                <br>
